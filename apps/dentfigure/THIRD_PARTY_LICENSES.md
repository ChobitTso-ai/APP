...
**Rule for DentFigure:** never commit real patient data of any kind — images,
radiographs, or exported figures built from them. Fixtures must be synthetic, with
documented provenance and licensing. This applies to the ordinary raster fixtures this
scope will need; it would apply with more force to DICOM, which is not planned.
