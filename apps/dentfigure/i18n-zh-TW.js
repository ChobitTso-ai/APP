...
(function () {
  ...
  const DICT = {
    ...
    // ── 面板標籤與標題 ─────────────────────────────
    'Panel labels': '面板標號 Label',
    'Panel Labels (A, B, C…)': '面板標號 Label(A、B、C…)',
    'Panel tags': '面板標籤 Tag',
    'Show tags': '顯示標籤 Tag',
    'Label': '標號 Label',
    'Label format': '標號 Label 格式',
    'labels': '標籤',
    'Labels': '標籤',
    '⊞ Labels': '⊞ 標籤',
    'Column labels': '欄標題',
    ...
    '📊 Normalize histograms': '📊 統一明暗',
    'Threshold': '閾值',
    '▨ Clipped': '▨ 過曝／過暗',
    '▨ clipped-pixel preview': '▨ 過曝／過暗預覽',
    ...
    '🩹 Cover patch (honest replace)': '🩹 遮蔽個資(可還原)',
    'Cover patch': '遮蔽個資',
